<%-- 
    ...
    Created on : 10-07-2019, 09:44:49 PM
  ...
  <header class="masthead text-center text-white">
    <div class="masthead-content">
      <div class="container">
        ...
        <h2 class="masthead-subheading mb-0">Categorias</h2>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 order-lg-1">
          <div class="p-5">
            <h2 class="display-4">Controlador de Categorias</h2>
            <form name="frmCategorias" class="form-group">
                <label class="bg-circle-1">ID CATEGORIA</label>
                <input type="text" name="id" id="id" class="form-inline"/><br>
                <label class="bg-circle-1">NOMBRE CATEGORIA</label>
                <input type="text" name="nombre" id="nombre" class="form-control"/><br>
                <label class="bg-circle-1">DESCRIPCION</label>
            ...
            <tr><th>ID Categoria</th><th>Nombre Categoria</th><th>Descripcion</th><th>Acción</th></tr>
