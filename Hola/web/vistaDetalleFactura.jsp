<%-- 
    Document   : vistaDetalleFactura
    Created on : 10-07-2019, 10:10:00 PM
  ...
  <header class="masthead text-center text-white">
    <div class="masthead-content">
      <div class="container">
        ...
        <h2 class="masthead-subheading mb-0">Detalle de Factura</h2>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 order-lg-1">
          <div class="p-5">
            <h2 class="display-4">Controlador de Detalle de Factura</h2>
            <form name="frmDetalleFactura" class="form-group">
                <label class="bg-circle-1">ID DETALLE DE FACTURA</label>
                <input type="text" name="idDetaFactura" id="idDetaFactura" class="form-inline"/><br>
                ...
                <label class="bg-circle-1">DESCUENTO</label>
                <input type="text" name="desc" id="desc" class="form-inline"/><br>
            ...
            <tr><th>ID Detalle</th><th>Producto<!--En ves de mostrar el ID traer el nombre--></th>
                <th>Cantidad</th><th>Ventas Afectadas</th><th>Descuento</th><th>Sub Total</th><th>Acción</th></tr>
