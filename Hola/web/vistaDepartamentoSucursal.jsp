<%-- 
    Document   : vistaDepartamentoSucursal
    Created on : 10-07-2019, 10:04:42 PM
  ...
  <header class="masthead text-center text-white">
    <div class="masthead-content">
      <div class="container">
        ...
        <h2 class="masthead-subheading mb-0">Departamento Sucursal</h2>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 order-lg-1">
          <div class="p-5">
            <h2 class="display-4">Controlador de Departamentos de Sucursales</h2>
            <form name="frmDeptoSucursal" class="form-group">
                <label class="bg-circle-1">ID DEPARTAMENTO SUCURSAL</label>
                <input type="text" name="idDepaSucursal" id="id" class="form-inline"/><br>
                <label class="bg-circle-1">NOMBRE DEPARTAMENTO SECURSAL</label>
                <input type="text" name="nombreDepaSucursal" id="nombre" class="form-control"/><br>
            ...
            <tr><th>ID DepartamentoSucrusal</th><th>Nombre DepartamentoSucursal</th><th>Acción</th></tr>
