<%-- 
    Document   : vistaDepartamento
    Created on : 10-07-2019, 10:00:38 PM
  ...
  <header class="masthead text-center text-white">
    <div class="masthead-content">
      <div class="container">
        ...
        <h2 class="masthead-subheading mb-0">Departamento Factura</h2>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 order-lg-1">
          <div class="p-5">
            <h2 class="display-4">Controlador de Departamentos de Factura</h2>
            <form name="frmDeptoFactura" class="form-group">
                <label class="bg-circle-1">ID DEPARTAMENTO</label>
                <input type="text" name="idDepaFactura" id="id" class="form-inline"/><br>
                <label class="bg-circle-1">NOMBRE DEPARTAMENTO</label>
                <input type="text" name="nombreDepaFactura" id="nombre" class="form-control"/><br>
            ...
            <tr><th>ID DepartamentoFactura</th><th>Nombre DepartamentoFactura</th><th>Acción</th></tr>
